...
function Dashboard() {
    ...
    return (
        <div className="flex min-h-screen bg-gray-100 flex-col sm:flex-row">
            ...
            {/* Desktop Sidebar */}
            <aside
                className="hidden sm:flex w-64 bg-blue-700 text-white flex-col p-6 sticky top-0 h-screen shadow-lg transition-all duration-300 ease-in-out z-10"
            >
                <div className="mb-4">
